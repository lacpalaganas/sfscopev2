import { Modal, View, Text, Pressable, StyleSheet, ScrollView, FlatList } from 'react-native';
import MaterialIcons from '@expo/vector-icons/MaterialIcons';
import styles from "./detailsoverlay.style";
export default function ViewDetailsOverlay({ isVisible, item, onClose, rentals }) {
    return (
